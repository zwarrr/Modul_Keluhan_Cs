        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/cs/rating">Ratting Saya</a></li>
                    ...
                    <div class="card card-outline card-info direct-chat direct-chat-info">
                        ...
                        <div class="card-footer bg-light">
                            <div class="alert alert-info mb-0" role="alert">
                                <i class="fas fa-info-circle"></i> <strong>View Only Mode:</strong> halaman ini hanya untuk melihat percakapan dari rating.
                            </div>
                        </div>
                    </div>
                </div>
